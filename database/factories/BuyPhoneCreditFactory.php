...
class BuyPhoneCreditFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        PhoneCreditProvider::first() ?? PhoneCreditProvider::factory()->create();

        Bank::first() ?? Bank::factory()->create();

        $dateTime = fake()->dateTime();

        $code = Str::code('BPC', $this->table, $dateTime, 1);
        ...
        return [
            'code' => $code,
            'phone_credit_provider_id' => PhoneCreditProvider::get()->random()->id,
