...
class ValueSeeder extends Seeder
{
    public function run()
    {
        ...
        $data->name_idn = 'International Enrichment Program';
        ...
        $data->description_idn = 'Bagi mahasiswa yang berprestasi, tersedia kesempatan magang di luar negeri seperti di Singapore, Australia, Korea Selatan dan Amerika Serikat.';
        $data->icon = 'flaticon-graduate-diploma';
        $data->save();

        $data = new Value();
        $data->name = '21st Century Skills';
        $data->name_idn = '21st Century Skills';
        ...
        $data->description_idn = 'Mahasiswa akan diperlengkapi dengan soft skills yang sangat diperlukan untuk berkarir, yaitu Communication, Collaboration, Critical Thinking, Creativity and Innovation Skills.';
        $data->icon = 'flaticon-classroom';
        $data->save();

        $data = new Value();
        $data->name = 'Future Technopreneur';
        $data->name_idn = 'Future Technopreneur';
        ...
        $data->description_idn = 'Mahasiswa akan dibekali dengan pengetahuan dan skill untuk menjadi technopreneur atau pemimpin bisnis TI melalui Harvest Start-up Center.';
        $data->icon = 'flaticon-graduation-cap';
        $data->save();

        $data = new Value();
        $data->name = 'Future Technology';
        $data->name_idn = 'Future Technology';
        ...
        $data->description_idn = 'Mahasiswa akan mempelajari teknologi terdepan yang sangat dibutuhkan industri pada 5-10 tahun mendatang, seperti Cloud Computing, Mobile Technology, Big Data, Internet of Things, Business Intelligence, dll.';
