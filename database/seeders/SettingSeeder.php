...
class SettingSeeder extends Seeder
{
    public function run()
    {
        ...
        $data->mission = "Organizing education in the field of information systems.<br><br>Carry out studies and developments in order to produce innovations that support the development of social life, especially in the field of information systems.<br><br>Prepare graduates in the field of information systems who are ready to work and have entrepreneurial skills.<br><br>Develop information systems education that prioritizes character development in the field of leadership with a global perspective.";
        $data->mission_id = "Menyelenggarakan pendidikan dalam bidang sistem informasi.<br><br>Melaksanakan kajian-kajian dan pengembangan guna menghasilkan inovasi yang mendukung pengembangan kehidupan bermasyarakat, khususnya di bidang sistem informasi.<br><br>Menyiapkan lulusan di bidang sistem informasi yang siap bekerja sekaligus memiliki kemampuan berwirausaha.<br><br>Mengembangkan pendidikan sistem informasi yang mengedepankan pengembangan karakter di bidang kepemimpinan yang berwawasan global.";
