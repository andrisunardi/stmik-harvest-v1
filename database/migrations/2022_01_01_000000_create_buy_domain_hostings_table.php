...
return new class extends Migration
{
    public function up()
    {
        Schema::create('buy_domain_hostings', function (Blueprint $table) {
            $table->id();
            $table->string('code', 17)->nullable()->unique();
            $table->foreignId('portfolio_id')->nullable()->unsigned();
            $table->foreignId('domain_hosting_provider_id')->nullable()->unsigned();
    ...
    {
        Schema::dropIfExists('buy_domain_hostings');
    }
};
