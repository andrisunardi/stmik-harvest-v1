...
class BlogTest extends TestCase
{
    ...
    public function test_index()
    {
        ...
        Livewire::test(BlogComponent::class)
            ...
            ->assertSee(Carbon::parse($blog->date)->isoFormat('LL'))
    ...
    public function test_search()
    {
        ...
        Livewire::test(BlogComponent::class)
            ...
            ->assertSee(Carbon::parse($blogs[1]->date)->isoFormat('LL'))
    ...
    public function test_view()
    {
        ...
        Livewire::test(BlogViewComponent::class, ['slug' => $blogs[0]->slug])
            ...
            ->assertSee(Carbon::parse($blogs[0]->date)->isoFormat('LL'))
            ...
            ->assertSee(Carbon::parse($blogs[2]->date)->isoFormat('LL'))
