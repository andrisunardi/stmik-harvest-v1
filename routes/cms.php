...
use App\Http\Livewire\CMS\ContactComponent;
...
use App\Http\Livewire\CMS\LogoutComponent;
...
use App\Http\Livewire\CMS\Profile\ActivityLogComponent;
use App\Http\Livewire\CMS\Profile\ChangePasswordComponent;
use App\Http\Livewire\CMS\Profile\EditProfileComponent;
use App\Http\Livewire\CMS\Profile\ProfileComponent;
use App\Http\Livewire\CMS\RegistrationComponent;
use App\Http\Livewire\CMS\SliderComponent;
...
Route::group(['middleware' => ['auth', 'role:'.config('app.route_cms_roles')]], function () {
    ...
    Route::any('slider', SliderComponent::class)->name('slider.index')->middleware('permission:Slider');
