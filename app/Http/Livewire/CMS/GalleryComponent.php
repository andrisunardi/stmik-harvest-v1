...
class GalleryComponent extends Component
{
    ...
    public function updatingYoutube()
    {
        $this->resetPage();
    }
    ...
    {
        $created_by = Gallery::groupBy("created_by")->onlyActive()->pluck("created_by");
        return Admin::whereIn("id", $created_by)->onlyActive()->orderBy("name")->get();
    }

    public function getDataUpdatedBy()
    {
        $updated_by = Gallery::groupBy("updated_by")->onlyActive()->pluck("updated_by");
        return Admin::whereIn("id", $updated_by)->onlyActive()->orderBy("name")->get();
    }

    public function getDataDeletedBy()
    {
        $deleted_by = Gallery::groupBy("deleted_by")->onlyActive()->pluck("deleted_by");
