...
class GalleryComponent extends Component
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'image' => 'required_if:category,1|nullable|max:'.env('MAX_IMAGE').'|mimes:'.env('MIMES_IMAGE'),
            'video' => 'required_if:category,2|nullable|max:'.env('MAX_VIDEO').'|mimes:'.env('MIMES_VIDEO'),
    ...
    public function active($id)
    {
        ...
        $active = Str::translate(Str::active($gallery->is_active));
