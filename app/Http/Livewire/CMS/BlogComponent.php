...
class BlogComponent extends Component
{
    ...
    {
        $created_by = Blog::groupBy('created_by_id')->active()->pluck('created_by_id');
    ...
    {
        $updated_by = Blog::groupBy('updated_by_id')->active()->pluck('updated_by_id');
    ...
    {
        $deleted_by = Blog::groupBy('deleted_by_id')->active()->pluck('deleted_by_id');
    ...
    public function getDataBlog()
    {
        if ($this->menu_type == 'index' || $this->menu_type == 'trash') {
            ...
            if ($this->created_by_id || $this->created_by_id == '0') {
                $data_blog->where('created_by_id', $this->created_by_id);
            }
            if ($this->updated_by_id || $this->updated_by_id == '0') {
                $data_blog->where('updated_by_id', $this->updated_by_id);
            }
            if ($this->deleted_by_id || $this->deleted_by_id == '0') {
                $data_blog->where('deleted_by_id', $this->deleted_by_id);
            }
            if ($this->active || $this->active == '0') {
                $data_blog->where('active', $this->active);
            }
