...
class AdmissionCalendarComponent extends Component
{
    ...
    {
        $created_by = AdmissionCalendar::groupBy("created_by")->onlyActive()->pluck("created_by");
        return Admin::whereIn("id", $created_by)->onlyActive()->orderBy("name")->get();
    }

    public function getDataUpdatedBy()
    {
        $updated_by = AdmissionCalendar::groupBy("updated_by")->onlyActive()->pluck("updated_by");
        return Admin::whereIn("id", $updated_by)->onlyActive()->orderBy("name")->get();
    }

    public function getDataDeletedBy()
    {
        $deleted_by = AdmissionCalendar::groupBy("deleted_by")->onlyActive()->pluck("deleted_by");
