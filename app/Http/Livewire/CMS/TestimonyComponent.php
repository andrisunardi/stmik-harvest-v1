...
class TestimonyComponent extends Component
{
    ...
    {
        $created_by = Testimony::groupBy('created_by_id')->active()->pluck('created_by_id');
    ...
    {
        $updated_by = Testimony::groupBy('updated_by_id')->active()->pluck('updated_by_id');
    ...
    {
        $deleted_by = Testimony::groupBy('deleted_by_id')->active()->pluck('deleted_by_id');
    ...
    public function getDataTestimony()
    {
        if ($this->menu_type == 'index' || $this->menu_type == 'trash') {
            ...
            if ($this->created_by_id || $this->created_by_id == '0') {
                $data_testimony->where('created_by_id', $this->created_by_id);
            }
            if ($this->updated_by_id || $this->updated_by_id == '0') {
                $data_testimony->where('updated_by_id', $this->updated_by_id);
            }
            if ($this->deleted_by_id || $this->deleted_by_id == '0') {
                $data_testimony->where('deleted_by_id', $this->deleted_by_id);
            }
