...
class BannerComponent extends Component
{
    ...
    {
        $created_by = Banner::groupBy('created_by')->active()->pluck('created_by');
    ...
    {
        $updated_by = Banner::groupBy('updated_by')->active()->pluck('updated_by');
    ...
    {
        $deleted_by = Banner::groupBy('deleted_by')->active()->pluck('deleted_by');
