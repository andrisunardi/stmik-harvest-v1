...
class UserComponent extends Component
{
    ...
    {
        $created_by = User::groupBy('created_by')->active()->pluck('created_by');
    ...
    {
        $updated_by = User::groupBy('updated_by')->active()->pluck('updated_by');
    ...
    {
        $deleted_by = User::groupBy('deleted_by')->active()->pluck('deleted_by');
    ...
    public function getDataUser()
    {
        if ($this->menu_type == 'index' || $this->menu_type == 'trash') {
            ...
            if ($this->created_by || $this->created_by == '0') {
                $data_user->where('created_by', $this->created_by);
            }
            if ($this->updated_by || $this->updated_by == '0') {
                $data_user->where('updated_by', $this->updated_by);
            }
            if ($this->deleted_by || $this->deleted_by == '0') {
                $data_user->where('deleted_by', $this->deleted_by);
            }
