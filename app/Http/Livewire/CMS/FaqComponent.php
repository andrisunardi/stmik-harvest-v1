...
class FaqComponent extends Component
{
    ...
    {
        $created_by = Faq::groupBy('created_by')->active()->pluck('created_by');
    ...
    {
        $updated_by = Faq::groupBy('updated_by')->active()->pluck('updated_by');
    ...
    {
        $deleted_by = Faq::groupBy('deleted_by')->active()->pluck('deleted_by');
