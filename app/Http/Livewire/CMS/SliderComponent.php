...
class SliderComponent extends Component
{
    ...
    {
        $created_by = Slider::groupBy('created_by_id')->active()->pluck('created_by_id');
    ...
    {
        $updated_by = Slider::groupBy('updated_by_id')->active()->pluck('updated_by_id');
    ...
    {
        $deleted_by = Slider::groupBy('deleted_by_id')->active()->pluck('deleted_by_id');
    ...
    public function getDataSlider()
    {
        if ($this->menu_type == 'index' || $this->menu_type == 'trash') {
            ...
            if ($this->created_by_id || $this->created_by_id == '0') {
                $data_slider->where('created_by_id', $this->created_by_id);
            }
            if ($this->updated_by_id || $this->updated_by_id == '0') {
                $data_slider->where('updated_by_id', $this->updated_by_id);
            }
            if ($this->deleted_by_id || $this->deleted_by_id == '0') {
                $data_slider->where('deleted_by_id', $this->deleted_by_id);
            }
