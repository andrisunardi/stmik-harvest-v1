 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Event[] $data_event
 * @property-read int|null $data_event_count
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|EventCategory nonActive()
