...
class StudyProgramCategory extends Model
{
    ...
    protected $table = "study_program_category";
    ...
    protected $guarded = ["study_program_category"];
    ...
    public function data_study_program()
    {
    ...
    {
        return $this->hasManyThrough(Course::class, StudyProgram::class);
    }
    ...
    public static function boot()
    {
        ...
        static::deleted(function ($table) {
            $table->data_study_program()->delete();
        });

        static::restored(function ($table) {
            $table->data_study_program()->restore();
        });
    }
}
