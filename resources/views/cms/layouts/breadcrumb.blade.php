        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 px-1 py-4">
                    ...
                    @endif
                    @if ($menu_type == "add")
                        <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-plus-lg me-1"></i> {{ trans("general.Add") }}</li>
                    @endif
                    @if ($menu_type == "clone")
                        <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-clipboard me-1"></i> {{ trans("general.Clone") }}</li>
                    @endif
                    @if ($menu_type == "edit")
                        <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-pencil me-1"></i> {{ trans("general.Edit") }}</li>
                    @endif
                    @if ($menu_type == "view")
                        <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-eye me-1"></i> {{ trans("general.View") }}</li>
                    @endif
                    @if ($menu_type == "trash")
                        <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-trash me-1"></i> {{ trans("general.Trash") }}</li>
                    @endif
                </ol>
            </nav>
        </div>
