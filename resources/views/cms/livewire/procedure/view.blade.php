    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            @if ($procedure->created_at)
                {{ $procedure->created_at->isoFormat("LLLL") }}<br class="d-md-none">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            @if ($procedure->updated_at)
                {{ $procedure->updated_at->isoFormat("LLLL") }}<br class="d-md-none">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6 col-md-8 col-lg-9">
                @if ($procedure->deleted_at)
                    {{ $procedure->deleted_at->isoFormat("LLLL") }}<br class="d-md-none">
