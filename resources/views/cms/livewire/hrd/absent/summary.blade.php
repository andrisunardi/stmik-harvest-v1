<div>
    ...
    <h6 class="lead">{{ trans("index.summary") }} @yield("title")</h6>
    <div class="row">
        <div class="col-sm-6 col-md-3">
            <div class="card bg-primary text-white mb-4">
                <div class="card-header">{{ trans("index.total_hours_remaining") }}</div>
                <div class="card-body">
                    {{ isset($summary["totalHoursRemaining"]) ? Str::thousand($summary["totalHoursRemaining"]) : 0 }}
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-md-3">
            <div class="card bg-success text-white mb-4">
                <div class="card-header">{{ trans("index.total_working_hours") }}</div>
                <div class="card-body">
                    {{ isset($summary["totalWorkingHours"]) ? Str::thousand($summary["totalWorkingHours"]) : 0 }}
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-md-3">
            <div class="card bg-warning text-white mb-4">
                <div class="card-header">{{ trans("index.total_working_days") }}</div>
                <div class="card-body">
                    {{ isset($summary["totalWorkingDays"]) ? Str::thousand($summary["totalWorkingDays"]) : 0 }}
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-md-3">
            <div class="card bg-danger text-white mb-4">
                <div class="card-header">{{ trans("index.total_days_off") }}</div>
                <div class="card-body">
                    {{ isset($summary["totalDaysOff"]) ? Str::thousand($summary["totalDaysOff"]) : 0 }}
                </div>
            </div>
        </div>
    </div>
