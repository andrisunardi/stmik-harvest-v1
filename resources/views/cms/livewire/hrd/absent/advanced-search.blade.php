            ...
            <div class="col-sm-4 col-lg-3 col-xl-auto mb-3">
                ...
                <div class="form-group">
                    ...
                    <select wire:model="{{ $input }}" class="form-select select2" id="{{ $input }}">
                        ...
                        <option value="user_id" {{ "user_id" == $order_by ? "selected" : null }}>{{ trans("index.employee") }}</option>
                        ...
                        <option value="duration" {{ "duration" == $order_by ? "selected" : null }}>{{ trans("index.duration") }}</option>
