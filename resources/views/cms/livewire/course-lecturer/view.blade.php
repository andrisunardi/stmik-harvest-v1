<div>
    ...
    <div class="row my-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9 col-xl-10">
            {{ $course_lecturer->created_at->format("H:i:s - l, d F Y") }} <br class="d-md-none"> ({{ $course_lecturer->created_at->diffForHumans() }})
        </div>
    </div>
    <div class="row my-2">
        <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9 col-xl-10">
            {{ $course_lecturer->updated_at->format("H:i:s - l, d F Y") }} <br class="d-md-none"> ({{ $course_lecturer->updated_at->diffForHumans() }})
        </div>
    </div>
    @if ($course_lecturer->trashed())
        <div class="row my-2">
            ...
            <div class="col-sm-6 col-md-8 col-lg-9 col-xl-10">
                {{ $course_lecturer->deleted_at->format("H:i:s - l, d F Y") }} <br class="d-md-none"> ({{ $course_lecturer->deleted_at->diffForHumans() }})
            </div>
        </div>
    @endif
    <div class="row my-2">
        @if ($course_lecturer->trashed())
            <div class="col-12 col-sm-auto mt-3 mt-sm-0">
                <button class="btn btn-creative btn-sm btn-success w-100" type="button" data-bs-toggle="modal" data-bs-target="#restore-{{ $course_lecturer->id }}">
            ...
            <div class="col-12 col-sm-auto mt-3 mt-sm-0">
                <button class="btn btn-creative btn-sm btn-danger w-100" type="button" data-bs-toggle="modal" data-bs-target="#delete-permanent-{{ $course_lecturer->id }}">
        ...
        @else
            <div class="col-6 col-sm-auto">
                <button class="btn btn-creative btn-sm btn-success w-100" wire:click="active({{ $course_lecturer->id }})">
                    <i class="bi bi-check-circle-fill me-1"></i>
                    {{ trans("button.Active") }}
                </button>
            </div>
            <div class="col-6 col-sm-auto">
                <button class="btn btn-creative btn-sm btn-danger w-100" wire:click="nonActive({{ $course_lecturer->id }})">
            ...
            <div class="col-6 col-sm-auto mt-3 mt-sm-0">
                <button class="btn btn-creative btn-sm btn-success w-100" wire:click="form('edit', {{ $course_lecturer->id }})">
                    <i class="bi bi-pencil me-1"></i>
                    {{ trans("button.Edit") }}
                </button>
            </div>
            <div class="col-6 col-sm-auto mt-3 mt-sm-0">
                <button class="btn btn-creative btn-sm btn-danger w-100" type="button" data-bs-toggle="modal" data-bs-target="#delete-{{ $course_lecturer->id }}">
