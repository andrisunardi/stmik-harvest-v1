    ...
    <div class="col-6 col-sm-4 col-lg-3 col-xl-auto">
        ...
        <div class="form-group">
            ...
            <select wire:model="{{ $input }}" class="form-select" id="{{ $input }}" name="{{ $input }}">
                ...
                <option value="study_program_category_id">{{ trans("field.Study Program Category") }}</option>
                ...
                <option value="degree">{{ trans("field.Degree") }}</option>
                <option value="duration">{{ trans("field.Duration") }}</option>
                <option value="price">{{ trans("field.Price") }}</option>
