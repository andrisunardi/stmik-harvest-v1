    ...
    <div class="col-6 col-sm-4 col-lg-3 col-xl-auto">
        ...
        <div class="form-group">
            ...
            <select wire:model="{{ $input }}" class="form-select" id="{{ $input }}" name="{{ $input }}">
                ...
                <option value="admin_id">{{ trans("field.Admin") }}</option>
                <option value="menu_id">{{ trans("field.Menu") }}</option>
                <option value="row">{{ trans("field.Row") }}</option>
                <option value="activity">{{ trans("field.Activity") }}</option>
