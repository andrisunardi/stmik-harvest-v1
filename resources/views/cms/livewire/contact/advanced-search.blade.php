            ...
            <div class="col-sm-4 col-lg-3 col-xl-auto mb-3">
                ...
                <div class="form-group">
                    ...
                    <select wire:model="{{ $input }}" class="form-select select2" id="{{ $input }}">
                        ...
                        <option value="subject" {{ "subject" == $order_by ? "selected" : null }}>{{ trans("index.subject") }}</option>
                        <option value="message" {{ "message" == $order_by ? "selected" : null }}>{{ trans("index.message") }}</option>
