            ...
            <div class="col-sm-4 col-lg-3 col-xl-auto mb-3">
                ...
                <div class="form-group">
                    ...
                    <select wire:model="{{ $input }}" class="form-select select2" id="{{ $input }}">
                        ...
                        <option value="domain_hosting_provider_id" {{ "domain_hosting_provider_id" == $order_by ? "selected" : null }}>{{ trans("index.domain_hosting_provider") }}</option>
                        <option value="payment_id" {{ "payment_id" == $order_by ? "selected" : null }}>{{ trans("index.payment") }}</option>
