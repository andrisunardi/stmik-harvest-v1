<table>
    ...
    @foreach ($advertisementProviders as $advertisementProvider)
        <tr>
            ...
            <td align="center">{{ $advertisementProvider->id }}</td>
            <td align="center">{{ $advertisementProvider->code }}</td>
            <td>{{ $advertisementProvider->name }}</td>
            <td>{{ $advertisementProvider->link }}</td>
            <td align="center">{{ trans("index." . Str::slug(Str::active($advertisementProvider->is_active), "_")) }}</td>
            <td align="center">{{ $advertisementProvider->buyAdvertisements->count() }}</td>
        </tr>
    @endforeach
</table>
