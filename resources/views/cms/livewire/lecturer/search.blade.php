    ...
    <div class="col-6 col-sm-4 col-lg-3 col-xl-auto">
        ...
        <div class="form-group">
            ...
            <select wire:model="{{ $input }}" class="form-select" id="{{ $input }}" name="{{ $input }}">
                ...
                <option value="code">{{ trans("field.Code") }}</option>
                <option value="name">{{ trans("field.Name") }}</option>
                <option value="description">{{ trans("field.Description") }}</option>
                <option value="job">{{ trans("field.Job") }}</option>
                <option value="phone">{{ trans("field.Phone") }}</option>
                <option value="email">{{ trans("field.Email") }}</option>
                <option value="facebook">{{ trans("field.Facebook") }}</option>
                <option value="twitter">{{ trans("field.Twitter") }}</option>
                <option value="instagram">{{ trans("field.Instagram") }}</option>
                <option value="linkedin">{{ trans("field.Linkedin") }}</option>
