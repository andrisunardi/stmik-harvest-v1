    ...
    <div class="col-6 col-sm-4 col-lg-3 col-xl-auto">
        ...
        <div class="form-group">
            ...
            <select wire:model="{{ $input }}" class="form-select" id="{{ $input }}" name="{{ $input }}">
                ...
                <option value="button_name">{{ trans("field.Button Name") }}</option>
                <option value="button_name_id">{{ trans("field.Button Name ID") }}</option>
                <option value="button_link">{{ trans("field.Button Link") }}</option>
