                    ...
                    @if ($image ? $image->temporaryUrl() : $testimony->checkImage())
                        ...
                        <div class="row mt-3">
                            <div class="col-6 col-md-auto">
                                <a draggable="false" class="btn btn-sm btn-primary w-100" href="{{ $image ? $image->temporaryUrl() : $testimony->assetImage() }}" target="_blank">
                                    <i class="fas fa-eye me-1"></i>
                                    {{ trans("index.view") }}
                                </a>
                            </div>
                            <div class="col-6 col-md-auto">
                                <a draggable="false" class="btn btn-sm btn-info text-white w-100" href="{{ $image ? $image->temporaryUrl() : $testimony->assetImage() }}" download>
