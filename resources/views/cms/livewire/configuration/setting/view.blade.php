<div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <span class="{{ "badge bg-" . Str::successdanger($setting->is_active) }}">
                {{ trans("index." . Str::slug(Str::active($setting->is_active), '_')) }}
            </span>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.finance.administrative-cost.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->administrativeCosts->count() }}
            </a>
        </div>
    </div>
    ...
    <div class="row mb-2">
        <div class="col-sm-6 col-md-4 col-lg-3">
            <h6>{{ trans("index.total") }} {{ trans("index.setting_interest") }}</h6>
        </div>
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.finance.setting-interest.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->settingInterests->count() }}
            </a>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.purchasing.buy-advertisement.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->buyAdvertisements->count() }}
            </a>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.purchasing.buy-domain-hosting.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->buyDomainHostings->count() }}
            </a>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.purchasing.buy-endorse.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->buyEndorses->count() }}
            </a>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.purchasing.buy-internet.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->buyInternets->count() }}
            </a>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.purchasing.buy-item.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->buyItems->count() }}
            </a>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.purchasing.buy-phone-credit.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->buyPhoneCredits->count() }}
            </a>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.finance.google-adsense.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->googleAdsenses->count() }}
            </a>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.finance.loyalty.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->loyalties->count() }}
            </a>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.finance.payment.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->payments->count() }}
            </a>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.finance.salary.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->salaries->count() }}
            </a>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9">
            <a draggable="false" href="{{ route("{$subDomain}.configuration.user.index") . "?setting_id={$setting->id}" }}" target="_blank">
                {{ $setting->users->count() }}
            </a>
        </div>
    </div>
