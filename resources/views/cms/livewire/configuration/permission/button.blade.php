        ...
        @if ($pageType == "index")
            ...
            @can("{$pageName} Export To Excel")
                <div class="col-12 col-sm-auto mb-3">
                    <button type="button" class="btn btn-success w-100" wire:click="exportToExcel" wire:loading.attr="disabled" {{ !$permissions->count() ? "disabled" : null }}>
            ...
            @can("{$pageName} Export To PDF")
                <div class="col-12 col-sm-auto mb-3">
                    <button type="button" class="btn btn-danger w-100" wire:click="exportToPdf" wire:loading.attr="disabled" {{ !$permissions->count() ? "disabled" : null }}>
