    ...
    <form wire:submit.prevent="submit" role="form" autocomplete="off">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6 mb-3">
                ...
                @if ($image || ($pageType != "add" && $googleAdsense->checkImage()))
                    @if ($image ? $image->temporaryUrl() : $googleAdsense->checkImage())
                        <img draggable="false" src="{{ $image ? $image->temporaryUrl() : $googleAdsense->assetImage() }}" class="w-100 mt-3" />
                        <div class="mt-3">
                            <a draggable="false" class="btn btn-sm btn-primary" href="{{ $image ? $image->temporaryUrl() : $googleAdsense->assetImage() }}" target="_blank">
                                <i class="fas fa-eye me-1"></i>
                                {{ trans("index.view") }}
                            </a>
                            <a draggable="false" class="btn btn-sm btn-info text-white" href="{{ $image ? $image->temporaryUrl() : $googleAdsense->assetImage() }}" download>
