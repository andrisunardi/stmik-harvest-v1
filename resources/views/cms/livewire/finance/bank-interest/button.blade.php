<div class="row">
    ...
    @if ($pageType == "index" || $pageType == "trash")
        ...
        @can("{$pageName} Export To Excel")
            <div class="col-12 col-sm-auto mb-3">
                <button type="button" class="btn btn-success w-100" wire:click="exportToExcel" wire:loading.attr="disabled" {{ !$bankInterests->count() ? "disabled" : null }}>
        ...
        @can("{$pageName} Export To PDF")
            <div class="col-12 col-sm-auto mb-3">
                <button type="button" class="btn btn-danger w-100" wire:click="exportToPdf" wire:loading.attr="disabled" {{ !$bankInterests->count() ? "disabled" : null }}>
    ...
    @if ($pageType == "trash")
        @can("{$pageName} Restore")
            <div class="col-12 col-sm-auto mb-3">
                <button type="button" class="btn btn-success w-100" data-bs-toggle="modal" data-bs-target="#restore-all" {{ !$bankInterests->count() ? "disabled" : null }}>
        ...
        @can("{$pageName} Delete Permanent")
            <div class="col-12 col-sm-auto mb-3">
                <button type="button" class="btn btn-danger w-100" data-bs-toggle="modal" data-bs-target="#delete-permanent-all" {{ !$bankInterests->count() ? "disabled" : null }}>
