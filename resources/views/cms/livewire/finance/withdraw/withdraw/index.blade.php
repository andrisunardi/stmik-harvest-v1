...
<div wire:init="loadData">
    ...
    @if ($pageType == "index" || $pageType == "trash")
        @include("{$subDomain}.livewire.{$pageCategorySlug}.{$pageSubCategorySlug}.{$pageSlug}.summary")
    @endif
...
@push("script")
    <script>
        ...
        $("#withdraw_category_id").on("change", function () {
            @this.set("withdraw_category_id", $(this).val())
        })
