    ...
    <form wire:submit.prevent="submit" role="form" autocomplete="off">
        ...
        <div class="row">
            <div class="form-group col-sm-6 mb-3">
                @php $input = "blog_category_id" @endphp
                ...
                <div class="input-group">
                    ...
                    <select
                        ...
                        @foreach ($blogCategories as $blogCategory)
                            <option value="{{ $blogCategory->id }}" {{ $blogCategory->id == $blog_category_id ? "selected" : null }}>{{ $blogCategory->name }}</option>
                        @endforeach
                    </select>
                    @error($input)
        ...
        <div class="row">
            <div class="form-group col-sm-6 mb-3">
                ...
                @if ($image || ($pageType != "add" && $blog->checkImage()))
                    @if ($image ? $image->temporaryUrl() : $blog->checkImage())
                        <a draggable="false" class="mt-3" href="{{ $image ? $image->temporaryUrl() : $blog->assetImage() }}" target="_blank">
                            <img draggable="false" src="{{ $image ? $image->temporaryUrl() : $blog->assetImage() }}" class="w-100 img-thumbnail" />
                        </a>
                        <div class="row mt-3">
                            <div class="col-6 col-md-auto">
                                <a draggable="false" class="btn btn-sm btn-primary w-100" href="{{ $image ? $image->temporaryUrl() : $blog->assetImage() }}" target="_blank">
                                    <i class="fas fa-eye me-1"></i>
                                    {{ trans("index.view") }}
                                </a>
                            </div>
                            <div class="col-6 col-md-auto">
                                <a draggable="false" class="btn btn-sm btn-info text-white w-100" href="{{ $image ? $image->temporaryUrl() : $blog->assetImage() }}" download>
