        ...
        <main class="text-center">
            ...
            <table class="table table-bordered">
                <tr>
                    ...
                    <th class="text-center">{{ trans("index.total") }} {{ trans("index.portfolio") }}</th>
                </tr>
                @foreach($portfolioCategories as $portfolioCategory)
                <tr>
                    <td class="text-center">{{ $loop->iteration }}</td>
                    <td class="text-center">{{ $portfolioCategory->id }}</td>
                    <td class="text-center">{{ $portfolioCategory->code }}</td>
                    ...
                    <td class="text-center">{{ trans("index." . Str::slug(Str::active($portfolioCategory->is_active), "_")) }}</td>
                    <td class="text-center">{{ $portfolioCategory->portfolios->count() }}</td>
                </tr>
                @endforeach
            </table>
        </main>
