            ...
            <div class="col-sm-4 col-lg-3 col-xl-auto mb-3">
                ...
                <div class="form-group">
                    ...
                    <select wire:model="{{ $input }}" class="form-select select2" id="{{ $input }}">
                        ...
                        <option value="status" {{ "status" == $order_by ? "selected" : null }}>{{ trans("index.status") }}</option>
                        ...
                        <option value="line" {{ "line" == $order_by ? "selected" : null }}>{{ trans("index.line") }}</option>
                        <option value="whatsapp" {{ "whatsapp" == $order_by ? "selected" : null }}>{{ trans("index.whatsapp") }}</option>
                        <option value="email" {{ "email" == $order_by ? "selected" : null }}>{{ trans("index.email") }}</option>
                        <option value="social_media" {{ "social_media" == $order_by ? "selected" : null }}>{{ trans("index.social_media") }}</option>
                        <option value="other" {{ "other" == $order_by ? "selected" : null }}>{{ trans("index.other") }}</option>
                        <option value="address" {{ "address" == $order_by ? "selected" : null }}>{{ trans("index.address") }}</option>
                        <option value="reference" {{ "reference" == $order_by ? "selected" : null }}>{{ trans("index.reference") }}</option>
                        <option value="domain" {{ "domain" == $order_by ? "selected" : null }}>{{ trans("index.domain") }}</option>
                        <option value="price" {{ "price" == $order_by ? "selected" : null }}>{{ trans("index.price") }}</option>
