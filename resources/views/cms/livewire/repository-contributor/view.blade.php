<div>
    ...
    <div class="row my-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9 col-xl-10">
            {{ $repository_contributor->code }}
        </div>
    </div>
    <div class="row my-2">
        <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
            <h6>{{ trans("field.Role") }}</h6>
        </div>
        <div class="col-sm-6 col-md-8 col-lg-9 col-xl-10">
            {{ $repository_contributor->role }}
        </div>
    </div>
    <div class="row my-2">
        <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
    ...
    <div class="row my-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9 col-xl-10">
            <a draggable="false" href="mailto:{{ $repository_contributor->email }}">{{ $repository_contributor->email }}</a>
        </div>
    </div>
    <div class="row my-2">
        <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
    ...
    @if ($repository_contributor->trashed())
        <div class="row my-2">
            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
    ...
    <div class="row my-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9 col-xl-10">
            {{ $repository_contributor->created_at->format("H:i:s - l, d F Y") }} <br class="d-md-none"> ({{ $repository_contributor->created_at->diffForHumans() }})
        </div>
    </div>
    <div class="row my-2">
        <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
        ...
        <div class="col-sm-6 col-md-8 col-lg-9 col-xl-10">
            {{ $repository_contributor->updated_at->format("H:i:s - l, d F Y") }} <br class="d-md-none"> ({{ $repository_contributor->updated_at->diffForHumans() }})
        </div>
    </div>
    @if ($repository_contributor->trashed())
        <div class="row my-2">
            ...
            <div class="col-sm-6 col-md-8 col-lg-9 col-xl-10">
                {{ $repository_contributor->deleted_at->format("H:i:s - l, d F Y") }} <br class="d-md-none"> ({{ $repository_contributor->deleted_at->diffForHumans() }})
            </div>
        </div>
    @endif
    <div class="row my-2">
        @if ($repository_contributor->trashed())
            <div class="col-12 col-sm-auto mt-3 mt-sm-0">
                <button class="btn btn-creative btn-sm btn-success w-100" type="button" data-bs-toggle="modal" data-bs-target="#restore-{{ $repository_contributor->id }}">
            ...
            <div class="col-12 col-sm-auto mt-3 mt-sm-0">
                <button class="btn btn-creative btn-sm btn-danger w-100" type="button" data-bs-toggle="modal" data-bs-target="#delete-permanent-{{ $repository_contributor->id }}">
        ...
        @else
            <div class="col-6 col-sm-auto">
                <button class="btn btn-creative btn-sm btn-success w-100" wire:click="active({{ $repository_contributor->id }})">
                    <i class="bi bi-check-circle-fill me-1"></i>
                    {{ trans("button.Active") }}
                </button>
            </div>
            <div class="col-6 col-sm-auto">
                <button class="btn btn-creative btn-sm btn-danger w-100" wire:click="nonActive({{ $repository_contributor->id }})">
            ...
            <div class="col-6 col-sm-auto mt-3 mt-sm-0">
                <button class="btn btn-creative btn-sm btn-success w-100" wire:click="form('edit', {{ $repository_contributor->id }})">
                    <i class="bi bi-pencil me-1"></i>
                    {{ trans("button.Edit") }}
                </button>
            </div>
            <div class="col-6 col-sm-auto mt-3 mt-sm-0">
                <button class="btn btn-creative btn-sm btn-danger w-100" type="button" data-bs-toggle="modal" data-bs-target="#delete-{{ $repository_contributor->id }}">
