            ...
            <div class="col-sm-4 col-lg-3 col-xl-auto mb-3">
                ...
                <div class="form-group">
                    ...
                    <select wire:model="{{ $input }}" class="form-select select2" id="{{ $input }}">
                        ...
                        <option value="question" {{ "question" == $order_by ? "selected" : null }}>{{ trans("index.question") }}</option>
                        <option value="question_idn" {{ "question_idn" == $order_by ? "selected" : null }}>{{ trans("index.question_idn") }}</option>
                        <option value="answer" {{ "answer" == $order_by ? "selected" : null }}>{{ trans("index.answer") }}</option>
                        <option value="answer_idn" {{ "answer_idn" == $order_by ? "selected" : null }}>{{ trans("index.answer_idn") }}</option>
