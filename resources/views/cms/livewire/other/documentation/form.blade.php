    ...
    <form wire:submit.prevent="submit" role="form" autocomplete="off">
        ...
        <div class="row">
            <div class="form-group col-sm-6 mb-3">
                ...
                @if ($image || ($pageType != "add" && $documentation->checkImage()))
                    @if ($image ? $image->temporaryUrl() : $documentation->checkImage())
                        <img draggable="false" src="{{ $image ? $image->temporaryUrl() : $documentation->assetImage() }}" class="w-100 mt-3" />
                        <div class="mt-3">
                            <a draggable="false" class="btn btn-sm btn-primary" href="{{ $image ? $image->temporaryUrl() : $documentation->assetImage() }}" target="_blank">
                                <i class="fas fa-eye me-1"></i>
                                {{ trans("index.view") }}
                            </a>
                            <a draggable="false" class="btn btn-sm btn-info text-white" href="{{ $image ? $image->temporaryUrl() : $documentation->assetImage() }}" download>
            ...
            <div class="form-group col-sm-6 mb-3">
                ...
                @if ($video || ($pageType != "add" && $documentation->checkVideo()))
                    @if ($video ? $video->temporaryUrl() : $documentation->checkVideo())
                        <video src="{{ $video ? $video->temporaryUrl() : $documentation->assetVideo() }}" class="w-100 mt-3" controls></video>
                        <div class="mt-3">
                            <a draggable="false" class="btn btn-sm btn-primary" href="{{ $video ? $video->temporaryUrl() : $documentation->assetVideo() }}" target="_blank">
                                <i class="fas fa-eye me-1"></i>
                                {{ trans("index.view") }}
                            </a>
                            <a draggable="false" class="btn btn-sm btn-info text-white" href="{{ $video ? $video->temporaryUrl() : $documentation->assetVideo() }}" download>
                                <i class="fas fa-download me-1"></i>
                                {{ trans("index.download") }}
                            </a>
                        </div>
