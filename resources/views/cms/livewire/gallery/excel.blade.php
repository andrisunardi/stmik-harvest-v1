<table>
    ...
    <tr><th align="center" colspan="12"><b>{{ Str::upper(Str::translate($title)) }}</b></th></tr>
    <tr><th align="center" colspan="12">{{ trans("index.printed_date") }} : {{ now()->isoFormat("LLLL") }}</th></tr>
    <tr></tr>
    <tr>
    ...
    @foreach ($galleries as $gallery)
        <tr>
            ...
            <td align="center">{{ Str::translate(Str::active($gallery->is_active)) }}</td>
        </tr>
    @endforeach
</table>
