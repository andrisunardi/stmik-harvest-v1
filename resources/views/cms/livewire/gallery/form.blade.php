                ...
                <div class="input-group">
                    ...
                    <select
                        ...
                        @foreach ($galleryCategories as $galleryCategory)
                            <option value="{{ $galleryCategory->value }}" {{ $galleryCategory->value == $category ? "selected" : null }}>{{ $galleryCategory->name }}</option>
                        @endforeach
                    </select>
                    @error($input)
        ...
        <div class="row">
            ...
            @if ($category == 3)
                <div class="form-group col-sm-6 mb-3">
                    ...
                    <div class="input-group">
                        <div class="input-group-text @if ($errors->any()) {{ $errors->has($input) ? "border-danger" : "border-success" }}@endif">
                            <span class="fab fa-youtube fa-fw @if ($errors->any()) {{ $errors->has($input) ? "text-danger" : "text-success" }}@endif"></span>
                        </div>
                        <input
                            class="form-control @if ($errors->any()) {{ $errors->has($input) ? "is-invalid" : "is-valid" }}@endif"
                            wire:model="{{ $input }}"
