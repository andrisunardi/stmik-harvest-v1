            ...
            <div class="col-sm-4 col-lg-3 col-xl-auto mb-3">
                ...
                <div class="form-group">
                    ...
                    <select wire:model="{{ $input }}" class="form-select select2" id="{{ $input }}">
                        ...
                        <option value="banner_category_id" {{ "banner_category_id" == $order_by ? "selected" : null }}>{{ trans("index.banner_category") }}</option>
                        ...
                        <option value="date" {{ "date" == $order_by ? "selected" : null }}>{{ trans("index.date") }}</option>
