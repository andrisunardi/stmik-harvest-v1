@section("title", trans("index.our_profile"))
@section("icon", "fas fa-user")
@section("our-profile-active", "active")
            ...
            <div class="row about__wrapper">
                ...
                <div class="col-lg-6">
                    <div class="about">
                        <p class="about__details">
                            {!! html_entity_decode(Str::setting(App::isLocale('en') ? 'about_us' : 'about_us_idn')) !!}
                        </p>
                        <p class="about__details">
                            <h3 class="text-uppercase mb-2">{{ trans("index.our_vision") }}</h3>
                            {!! html_entity_decode(Str::setting(App::isLocale('en') ? 'vision' : 'vision_idn')) !!}
                        </p>
                        <p class="about__details">
                            <h3 class="text-uppercase mb-2">{{ trans("index.our_mission") }}</h3>
                            {!! html_entity_decode(Str::setting(App::isLocale('en') ? 'mission' : 'mission_idn')) !!}
                        </p>
                        {{-- <p class="about__details">
                ...
                <div class="col-lg-6">
                    <p class="about__details">
                        ...
                        {!! html_entity_decode(Str::setting(App::isLocale('en') ? 'history' : 'history_idn')) !!}
                    </p>
                    {{-- <p class="about__details">
                        <h3 class="text-uppercase mb-2">{{ trans("index.our_history") }}</h3>
