@section("title", trans("index.portfolio"))
...
<div>
    <div class="section mt-2">
        ...
        <h6 class="text-center h6">
            @if (App::isLocale("en"))
                We take seriously in the work we do for each every one of our portfolio
            @else
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-7 col-lg-8 col-xl-9 order-first order-md-last">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <button type="button" class="btn btn-block btn-{{ 8 * $page < $totalPortfolio ? "primary" : "secondary disabled" }} mb-2" wire:click="loadMore()" wire:loading.attr="disabled" {{ 8 * $page < $totalPortfolio ? null : "disabled" }}>
