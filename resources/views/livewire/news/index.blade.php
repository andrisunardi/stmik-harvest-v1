@section("title", trans("index.news"))
...
<div>
    <div class="section mt-2">
        ...
        <h6 class="text-center h6">
            @if (App::isLocale("en"))
                We take seriously in the work we do for each every one of our news
            @else
                    ...
                    @foreach($newss as $news)
                        <div class="col-sm-6 col-xl-4 mb-2">
                            <div class="card h-100">
                                ...
                                <hr>
                                <div class="text-center mb-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ trans("index.news_category") }}">
                                    <a draggable="false" href="{{ route("news.category.view", ["slug" => $news->newsCategory->slug]) }}" >
                                        {{ $news->newsCategory->translate_name }}
                                    </a>
                                </div>
